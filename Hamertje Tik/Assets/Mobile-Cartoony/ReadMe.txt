...
A simple colorable UI for mobile and puzzle games. Note that not every component is set up in the NGUI atlas and skin. There are some additional sliders and buttons which you might like to use in your own project.
...
----------------------
Mobile-Colorable
 - Mobile-Colorable     The sample scenes are here for Unity GUI and NGUI.
...
1. Add the ColoredGUISkinMobile object to any GameObject
2. Call ColoredGUISkinMobile.Instance.UpdateGuiColors(primaryColor, secondaryColor) from any Start() method.
3. Access the skin with ColoredGUISkinMobile.Skin
